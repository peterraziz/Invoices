...
class InvoicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('pic')) {
            ...
            // $user = User::first();  // MAIN CODE
            // $user->notify(new AddInvoice($invoice_id));   // MAIN CODE
            // //or:    //////////////////////////////////////////////////////
            // // Notification::send($user, new AddInvoice($invoice_id)); 
            
        // code for Database notifications IN SITE: 
        $user = User::get(); // get= to all users
        // $user = User::find(Auth::user()->id); // find= send notification only to the user who made the invoice
    ...
    public function destroy(Request $request)
    {
        ...
        if(!empty($Details->invoice_number)) {
            ...
            // if i want to delete just the attachment inside Directory : 
...
// code for mark all as read in main-header لما ادوس قراءة الكل ف يمسح كل النوتس
