				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							{{-- SHOW NOTIFICATION TO THE OWNER ONLY --}}
								...
								<div class="dropdown-menu">
									...
									<div class="main-notification-list Notification-scroll" id="unreadNotifications">
										...
										@foreach (auth()->user()->unreadNotifications as $notifications) 
											<a class="d-flex p-1 border-bottom" 
											href="{{ url('InvoicesDetails') }}/{{ $notifications->data['id'] }}">
												<div class="notifyimg bg-success">
													<i class="la la-envelope-open text-white"></i>
												</div>
												<div class="mr-3">
													<h5 class="notification-label mb-1">
														{{$notifications->data ['title'] }} {{$notifications->data ['user'] }}
													</h5>
													<div class="notification-subtext">التاريخ: {{$notifications->created_at}}</div>
												</div>
												<div class="mr-auto">
